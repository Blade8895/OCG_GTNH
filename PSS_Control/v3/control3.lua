...
function storage_calc()
 ...
 return storage_percent_bar, storage_percent, storage_max, storage_actual, storage_print
end
-- end 
...
function refresh()
 ...
 format_number(storage_print)
 term.setCursor(36,14)
 aw.write("<color fg=0x00ff00> "..tostring(formatted).."% </color>")
